...
여기서 말하는 4개 platform은 현재 조직 표준 line 예시다.
구조 원칙상 같은 1계층 OSS를 바탕으로 다른 2계층 platform line을 추가로 만들 수 있다.
중요한 건 서비스가 raw OSS 대신 자신이 선택한 2계층 line만 소비하는 것이다.
...
- 1계층 OSS는 특정 2계층 line 하나에 종속되지 않는다.
- 여러 2계층 platform line이 같은 1계층 OSS를 재조립할 수 있다.
